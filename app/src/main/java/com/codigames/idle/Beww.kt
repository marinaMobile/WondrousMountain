...
import com.codigames.idle.Classss.Companion.MAIN_ID
import com.codigames.idle.databinding.ActivityBewwBinding
...
class Beww : AppCompatActivity() {
    ...
    lateinit var bind: ActivityBewwBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityBewwBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "wondrousmountain.xyz/go.php?to=2&"
